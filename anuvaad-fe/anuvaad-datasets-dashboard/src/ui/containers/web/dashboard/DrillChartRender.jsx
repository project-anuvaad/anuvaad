...
class DrillCharts extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleOnClick(event) {
        ...
        history.push(`${process.env.PUBLIC_URL}/parallel-corpus/${this.props.match.params.lang}/${event.pairType}`);
    }
