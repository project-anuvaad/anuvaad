        ...
        <div style={{ height: window.innerHeight, overflow: 'hidden' }}>
          <Grid container spacing={8}>
            ...
            <Grid item xs={12} sm={8} lg={7} xl={7} className={classes.signUpPaper} >
              ...
              <Typography>
                <Link id="forgotpassword" style={{ cursor: 'pointer', color: '#0C8AA9', marginLeft: '25%', float: 'left' }} href="#" onClick={() => { history.push(`${process.env.PUBLIC_URL}/forgot-password`); }}> forgot password</Link>
                <Link id= "signup" style={{ cursor: 'pointer', color: '#0C8AA9', marginRight: '25%', float: 'right' }} href="#" onClick={() =>{ history.push(`${process.env.PUBLIC_URL}/signup`); }}> Sign up</Link>
              </Typography>
            </Grid>
          </Grid>
