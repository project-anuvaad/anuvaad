        ...
        <ThemeProvider theme={themeAnuvaad}>
            ...
            >
                ...
                <DialogTitle id="alert-dialog-title">{"Update your email ID"}</DialogTitle>
                    <Typography>For Accessing this portal, you will need to go through MFA authentication which requires a valid email Id. Please update or confirm your email Id - </Typography>
                    <DialogContent style={{ overflow: "hidden", marginTop: 50, marginBottom: 50, display: "flex", justifyContent: "space-around", alignItems: "center" }}>
                        ...
                        <div>
                            ...
                            <Typography variant="caption">{currentEmail}</Typography>
                        </div>
                    </DialogContent> 
                    </>}      
            </Dialog>
