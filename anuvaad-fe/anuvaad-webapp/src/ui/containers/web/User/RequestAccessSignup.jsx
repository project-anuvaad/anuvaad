...
class RequestAccessSignup extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      firstName: "",
    ...
    return (
      <MuiThemeProvider theme={ThemeDefault}>
            {/* <Grid item xs={12} sm={12} lg={7} xl={7} className={classes.signUpPaper} > */}
              <Typography align='center' variant='h3' className={classes.headingStyle}>Request Access</Typography>

              <FormControl align='center' fullWidth >
                <TextField value={this.state.firstName} id="first-name" placeholder={translate('common.page.label.name')}
                ...
                {/* <FormControl align='center' fullWidth> */}
                <TextField value={this.state.email} id="email" type="email-username" placeholder={translate('common.page.label.email')}
              ...
              <FormControl align='center' fullWidth> */}
                ...
                <div className={classes.wrapper}>
                  <Button
                    ...
                    {"Request Access"}
                    {this.state.loading && <CircularProgress size={24} className={`'success' ${classes.buttonProgress}`} />}
                  </Button>
                </div>
