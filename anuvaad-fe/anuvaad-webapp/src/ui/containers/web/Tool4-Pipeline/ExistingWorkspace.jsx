...
class ExistingWorkspace extends React.Component {
  ...
  handleFetchWorkspace = () => {
    ...
    const apiObj = new FetchCompositionWorkspace(this.state.rowsPerPage, this.state.page + 1, "PROCESSED", "");
    APITransport(apiObj);
  ...
  handleReset = val => {
    const { APITransport } = this.props;
    const apiObj = new FetchCompositionWorkspace(this.state.rowsPerPage, this.state.page + 1, "PROCESSED", "", val);
    APITransport(apiObj);
  ...
  changePage = (page, rowsPerPage) => {
    const { APITransport } = this.props;
    const apiObj = new FetchCompositionWorkspace(rowsPerPage, page + 1, "PROCESSED", "");
    APITransport(apiObj);
