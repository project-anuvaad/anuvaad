        ...
        <div>
          ...
          >
            ...
            <Grid item xs={12} sm={6} lg={6} xl={6}>
              <Paper elevation={2}>
                {this.state.tokenized ?
                  <Toolbar style={{ color: '#000000', background: this.state.edited ? "#989E9C" : '#9E9E9E' }}>
                  ...
                  <Toolbar style={{ color: '#000000', backgroundColor: '#9E9E9E' }}>
            ...
            <Grid item xs={12} sm={6} lg={6} xl={6}>
              <Paper elevation={2}>
                {!this.state.tokenized ?
                  <Toolbar style={{ color: '#000000', background: this.state.pageDetails === "target" ? "#989E9C" : '#9E9E9E' }}>
