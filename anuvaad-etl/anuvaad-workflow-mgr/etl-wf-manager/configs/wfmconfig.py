...
config_file_url = os.environ.get('ANUVAAD_ETL_WF_CONF', 'https://raw.githubusercontent.com/project-anuvaad/anuvaad/wf_manager/anuvaad-etl/anuvaad-workflow-mgr/config/etl-wf-manager-config-prod.yml')
