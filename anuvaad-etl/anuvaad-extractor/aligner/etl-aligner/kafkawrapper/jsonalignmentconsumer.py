            ...
            for msg in consumer:
                ...
                try:
                    ...
                    if data:
                        ...
                        json_align_cons_thread = threading.Thread(target=jsonservice.process, args=(data, False), name=thread_name)
                        json_align_cons_thread.start()
