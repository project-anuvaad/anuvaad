...
class Block_Segmenter_WF(Resource):
    ...
    def post(self):
        ...
        log_info("Resource Block_Segmenter_WF  service started", app_context.application_context)
        ...
        try:
            ...
            if error_validator.format_error(json_data) is True:
                ...
                log_info("Resource Block_Segmenter_WF api response completed", app_context.application_context)
                return jsonify(response)
        except FormatError as e:
            log_error("Resource Block_Segmenter_WF Input json format is not correct or dict_key is missing", app_context.application_context, e)
            return Status.ERR_request_input_format.value


# rest request for layout detection individual service
class Bolck_Segmenter(Resource):
    ...
    def post(self):
        ...
        app_context.init()
        app_context.application_context = json_data
        log_info("Resource Bolck_Segmenter service started", app_context.application_context)
        ...
        try:
            ...
            if error_validator.format_error(json_data) is True:
                ...
                log_info("Resource Bolck_Segmenter api response completed", app_context.application_context)
                return jsonify(response)
        except FormatError as e:
            log_error("Resource Bolck_Segmenter Input json format is not correct or dict_key is missing", app_context.application_context, e)
            return Status.ERR_request_input_format.value
