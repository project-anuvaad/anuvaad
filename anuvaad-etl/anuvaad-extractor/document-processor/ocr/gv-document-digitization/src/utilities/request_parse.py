...
class File:
    ...
    def get_region_lines(self, page_index,region_index):
        if 'regions' in self.file['pages'][page_index]['regions'][region_index].keys():
            return self.file['pages'][page_index]['regions'][region_index]['regions']
        else:
            return None
    @log_error
    def get_region_words(self, page_index,region_index,child_index):
        return self.file['pages'][page_index]['regions'][region_index]['regions'][child_index]['dataregions']
