...
class Tesseract_OCR_WF(Resource):
    ...
    def post(self):
        ...
        task_id = str("TesseractOCR-" + str(time.time()).replace('.', '')[0:13])
...
class Tesseract_OCR(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            log_error("Resource Tesseract_OCR Input json format is not correct or dict_key is missing" + str(e), app_context.application_context, e)
            return Status.ERR_request_input_format.value
