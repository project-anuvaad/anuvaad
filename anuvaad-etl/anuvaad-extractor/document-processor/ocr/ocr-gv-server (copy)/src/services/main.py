...
import config,copy
from src.utilities.request_parse import get_files, File,get_json,get_ocr_config
...
def process_input(app_context,base_dir) :
    try:
        ...
        for index,file in enumerate(files):
            ...
            ocr_level, lang = get_ocr_config(file, file_properties.get_pages())
            page_res = text_extraction(file_properties,page_paths,file,ocr_level, lang)
