...
class AnuvaadPunjabiTokenizer(object):
    ...
    incomplete char range = ([\u0A01-\u0A03,\u0A3C-\u0A51,\u0A64-\u0A65, \u0A70-\u0A76])
    complete char range = ([\u0A05-\u0A39,\u0A59-\u0A5E])    
    number range = ([\u0A66-\u0A6F])
    source for unicodes : https://unicode.org/charts/PDF/U0A00.pdf
    """
    _abbrevations_with_non_generalize_pattern = []
    _abbrevations_with_non_generalize = []
    _text_abbrevations_pattern_cic = r'((\s)(([\u0A05-\u0A39,\u0A59-\u0A5E])([\u0A01-\u0A03,\u0A3C-\u0A51,\u0A64-\u0A65, \u0A70-\u0A76])?([\u0A05-\u0A39,\u0A59-\u0A5E])?(\u002e)(\s)?){1,})'
    _text_abbrevations_pattern_cci = r'((\s)(([\u0A05-\u0A39,\u0A59-\u0A5E])([\u0A05-\u0A39,\u0A59-\u0A5E])?([\u0A01-\u0A03,\u0A3C-\u0A51,\u0A64-\u0A65, \u0A70-\u0A76])?(\u002e)(\s)?){1,})'
    _text_colon_abbreviations_pattern = r'(([\u0A05-\u0A39,\u0A59-\u0A5E])([\u0A01-\u0A03,\u0A3C-\u0A51,\u0A64-\u0A65, \u0A70-\u0A76])?[:](\s)?[\u0A01-\u0A76|-])'
    _text_abbrevations_without_space_pattern = r'(^(([\u0A05-\u0A39,\u0A59-\u0A5E])([\u0A01-\u0A03,\u0A3C-\u0A51,\u0A64-\u0A65, \u0A70-\u0A76])?([\u0A05-\u0A39,\u0A59-\u0A5E])?([\u0A01-\u0A03,\u0A3C-\u0A51,\u0A64-\u0A65, \u0A70-\u0A76])?(\u002e)(\s)?){1,})'
