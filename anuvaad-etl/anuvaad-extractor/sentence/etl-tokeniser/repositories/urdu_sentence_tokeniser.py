...
"""
class AnuvaadUrduTokenizer(object):
    """
    Default abbrevations
    incomplete char range = ([\u0600-\u061B,\u061D-\u061F,\u0640,\u064B-\u065F,\u066A-\u066D,\u06D4,\u06D6-\u06ED,\u06FD-\u06FE])
    complete char range = ([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])     
    number range = ([\u0660-\u0669,\u06F0-\u06F9])
    source for unicodes : https://unicode.org/charts/PDF/U0600.pdf
    """
    _abbrevations_with_non_generalize_pattern = []
    _abbrevations_with_non_generalize = []
    _text_abbrevations_pattern_cic = r'((\s)(([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])([\u0600-\u061B,\u061D-\u061F,\u0640,\u064B-\u065F,\u066A-\u066D,\u06D4,\u06D6-\u06ED,\u06FD-\u06FE])?([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])?(\u002e)(\s)?){1,})'
    _text_abbrevations_pattern_cci = r'((\s)(([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])?([\u0600-\u061B,\u061D-\u061F,\u0640,\u064B-\u065F,\u066A-\u066D,\u06D4,\u06D6-\u06ED,\u06FD-\u06FE])?(\u002e)(\s)?){1,})'
    _text_colon_abbreviations_pattern = r'(([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])([\u0600-\u061B,\u061D-\u061F,\u0640,\u064B-\u065F,\u066A-\u066D,\u06D4,\u06D6-\u06ED,\u06FD-\u06FE])?[:](\s)?[\u0600-\u06FF|-])'
    _text_abbrevations_without_space_pattern = r'(^(([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])([\u0600-\u061B,\u061D-\u061F,\u0640,\u064B-\u065F,\u066A-\u066D,\u06D4,\u06D6-\u06ED,\u06FD-\u06FE])?([\u061C,\u0620-\u063F,\u0641-\u064A,\u066E-\u06D3,\u06D5,\u06EE-\u06EF,\u06FA-\u06FC,\u06FF])?([\u0600-\u061B,\u061D-\u061F,\u0640,\u064B-\u065F,\u066A-\u066D,\u06D4,\u06D6-\u06ED,\u06FD-\u06FE])?(\u002e)(\s)?){1,})'
    ...
    def serialize_end(self, text):
        ...
        text = pattern_d.sub(' END_D', text)
        pattern = re.compile(r'(\u061F)')
        text = pattern.sub(' END_E', text)
        return text

    def deserialize_end(self, text):
        pattern = re.compile(re.escape(' END_D'), re.IGNORECASE)
        text = pattern.sub('۔', text)
        pattern = re.compile(re.escape(' END_E'), re.IGNORECASE)
        text = pattern.sub('؟', text)
        return text
