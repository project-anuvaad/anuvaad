...
class JobRepository:
    ...
    def upsert(self, key, value):
        try:
            ...
            log_exception("Exception in TK REPO: upsert | Cause: " + str(e), None, e)
            return None
    ...
    def delete(self, key):
        try:
            ...
            log_exception("Exception in TK REPO: delete | Cause: " + str(e), None, e)
            return None
    ...
    def search(self, key_list):
        try:
            ...
            log_exception("Exception in TK REPO: search | Cause: " + str(e), None, e)
            return None
