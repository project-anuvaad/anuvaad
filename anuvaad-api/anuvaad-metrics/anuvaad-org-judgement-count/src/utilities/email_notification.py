...
def generate_email_notification(users, sting_data):
    ...
    message["Subject"] = f" ANUVAAD - Stats {tdy_date}"
...
def send_email(message):
    try:
        ...
        log_exception(
            "Exception while generating email notification for ANUVAAD - STATS for scheduler statistics: {}".format(
                e
            ),
            MODULE_CONTEXT,
            e,
