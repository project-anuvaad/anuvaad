...
VERIFY_USERS                    =   os.environ.get('VERIFY_USER', 'verify-user')
...
EMAIL_GET_URL_NOTIFICATION = os.environ.get('NOTIFICATION_URL', 'http://127.0.0.1:5001/anuvaad/user-mgmt/v1/users/validated-and-onboard')
